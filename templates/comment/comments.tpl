...
{if $comment}
	...
	<h4>{if $user}{translate key="comments.authenticated" userName=$comment->getPosterName()|escape}{elseif $comment->getPosterName()}{translate key="comments.anonymousNamed" userName=$comment->getPosterName()|escape}{else}{translate key="comments.anonymous"}{/if} ({showdate value=$comment->getDatePosted() format=$dateFormatShort})</h4>
...
<h5>{if $user}{translate key="comments.authenticated" userName=$child->getPosterName()|escape}{elseif $child->getPosterName()}{translate key="comments.anonymousNamed" userName=$child->getPosterName()|escape}{else}{translate key="comments.anonymous"}{/if} ({showdate value=$child->getDatePosted() format=$dateFormatShort})</h5>
...
{assign var=user value=$grandChild->getUser()}
	<li>
		...
		{if $user}{translate key="comments.authenticated" userName=$grandChild->getPosterName()|escape}{elseif $grandChild->getPosterName()}{translate key="comments.anonymousNamed" userName=$grandChild->getPosterName()|escape}{else}{translate key="comments.anonymous"}{/if} ({showdate value=$grandChild->getDatePosted() format=$dateFormatShort})
	</li>
{/foreach}
{if $grandChildren}
	</ul>
