...
<table width="100%" class="info">
	...
	<tr>
		...
		<td>{showdate value=$submission->getDateNotified() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getDateUnderway() format=$dateFormatShort}</td>
		<td>
			...
			{/if}
			{showdate value=$submission->getDateCompleted() format=$dateFormatShort default=""}
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td>{showdate value=$submission->getDateAuthorNotified() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getDateAuthorUnderway() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getDateAuthorCompleted() format=$dateFormatShort}</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="4">
	...
	<tr>
		...
		<td width="20%">{showdate value=$submission->getDateFinalNotified() format=$dateFormatShort}</td>
		<td width="20%">{showdate value=$submission->getDateFinalUnderway() format=$dateFormatShort}</td>
		<td width="20%">
			...
			{else}
				...
				{icon name="mail" onclick="return confirm('$confirmMessage')" url=$url}
			{/if}
			{showdate value=$submission->getDateFinalCompleted() format=$dateFormatShort default=""}
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
