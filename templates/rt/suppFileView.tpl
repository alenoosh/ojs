...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">{showdate value=$suppFile->getDateCreated() format=$dateFormatShort}</td>
	</tr>
	<tr valign="top">
...
{if $suppFile}
	...
	<tr valign="top">
		...
		<td class="value">{showdate value=$suppFile->getDateUploaded() format=$datetimeFormatShort}</td>
	</tr>
	</table>
{else}
	<tr valign="top">
