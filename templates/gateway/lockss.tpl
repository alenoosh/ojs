...
<div style="text-align: center; width: 250px; margin: 0 auto">
	<a href="http://lockss.stanford.edu/"><img src="{$baseUrl}/templates/images/lockss.gif" style="border: 0;" alt="LOCKSS" title="LOCKSS" /></a>
	<br />
	LOCKSS system has permission to collect, preserve, and serve this Archival Unit.
		
	<br /><br />
	
	<a href="http://pkp.sfu.ca/"><img src="{$baseUrl}/templates/images/pkp.gif" style="border: 0;" alt="The Public Knowledge Project" title="The Public Knowledge Project" /></a>
	<br />
