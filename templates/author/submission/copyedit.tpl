...
<table width="100%" class="info">
	...
	<tr>
		...
		<td>{showdate value=$submission->getCopyeditorDateNotified() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getCopyeditorDateUnderway() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getCopyeditorDateCompleted() format=$dateFormatShort}</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="4">
			...
			{if $submission->getCopyeditorDateCompleted() && $initialCopyeditFile}
				<a href="{url op="downloadFile" path=$submission->getArticleId()|to_array:$initialCopyeditFile->getFileId():$initialCopyeditFile->getRevision()}" class="file">{$initialCopyeditFile->getFileName()|escape}</a>&nbsp;&nbsp;{showdate value=$initialCopyeditFile->getDateModified() format=$dateFormatShort}
			{else}
	...
	<tr>
		...
		<td>{showdate value=$submission->getCopyeditorDateAuthorNotified() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getCopyeditorDateAuthorUnderway() format=$dateFormatShort}</td>
		<td>
			...
			{/if}
			{showdate value=$submission->getCopyeditorDateAuthorCompleted() format=$dateFormatShort default=""}
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td>{showdate value=$submission->getCopyeditorDateFinalNotified() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getCopyeditorDateFinalUnderway() format=$dateFormatShort}</td>
		<td>{showdate value=$submission->getCopyeditorDateFinalCompleted() format=$dateFormatShort}</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="4">
