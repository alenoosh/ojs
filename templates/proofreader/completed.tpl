...
{iterate from=submissions item=submission}
	...
	<tr valign="top">
		...
		<td>{showdate value=$proofAssignment->getDateProofreaderNotified() format=$dateFormatTrunc}</td>
		...
		<td>{showdate value=$proofAssignment->getDateProofreaderCompleted() format=$dateFormatTrunc}</td>
		<td align="right">
