...
{iterate from=submissions item=submission}
	...
	<tr valign="top">
		...
		<td>{showdate value=$proofAssignment->getDateProofreaderNotified() format=$dateFormatTrunc type=$calType}</td>
		...
		<td>{showdate value=$proofAssignment->getDateProofreaderCompleted() format=$dateFormatTrunc type=$calType}</td>
		<td align="right">
