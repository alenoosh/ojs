...
<tr valign="top">	
	...
	{* size of username input box is changed *}
...
{if $captchaEnabled}
	<tr>
		...
		<td class="value">
			<img src="{url page="user" op="viewCaptcha" path=$captchaId}" alt="{translate key="common.captchaField.altText"}" title="{translate key="common.captchaField.altText"}" /><br />
...
<tr valign="top">
	...
	<td class="value"><input type="text" id="middleName" name="middleName[{$formLocale|escape}]" value="{$middleName[$formLocale]|escape|nl2br}" size="20" maxlength="40" class="textField" /></td>
</tr>
	
<tr valign="top">
	<td class="label">{fieldLabel name="lastName" required="true" key="user.lastName"}</td>
	<td class="value"><input type="text" id="lastName" name="lastName[{$formLocale|escape}]" value="{$lastName[$formLocale]|escape|nl2br}" size="20" maxlength="90" class="textField" /></td>
</tr>
