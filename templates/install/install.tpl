...
<table width="100%" class="data">
	<tr valign="top">	
		...
		{* Opatan Inc. : size of adminUsername input box is changed *}
    	...
    	{* Opatan Inc. : username restriction is added for admin username *}
    	<tr valign="top">
	    	<td></td>
	...
	<tr valign="top">
    	...
    	{* Opatan Inc. : adminEmail input box is removed *}
</table>
