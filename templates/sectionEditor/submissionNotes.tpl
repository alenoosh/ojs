...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td class="value" width="80%">{showdate value=$articleNote->getDateModified() format=$datetimeFormatShort}</td>
	</tr>
	<tr valign="top">
...
{iterate from=submissionNotes item=note}
	<tr valign="top">
		<td>
			...
			{showdate value=$note->getDateCreated() format=$dateFormatTrunc}
		</td>
